...
class Data extends \Magento\Framework\App\Helper\AbstractHelper {
    ...
    public function getCategoryProduct()
    {
         ...
         $tvc_prod_data = $this->tvc_blockFactory->createBlock('Magento\Catalog\Block\Product\ListProduct');
         $tvc_prod_data->getLoadedProductCollection()->setPageSize($this->setPageLimit());
         $tvc_prod_data->getLoadedProductCollection()->setCurPage($this->getCurrentPage());
        ...
        foreach ($tvc_prod_data->getLoadedProductCollection() as $product){
