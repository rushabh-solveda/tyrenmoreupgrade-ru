...
class SaveGstToInvoice implements ObserverInterface
{
    ...
    public function __construct(Data $helper, ProductFactory $productFactory, CategoryRepositoryInterface $categoryRepository, StoreManagerInterface $storeManager, QuoteFactory $quoteFactory)
    {
        $this->helper = $helper;
    ...
    public function execute(Observer $observer)
    {
        try {
            ...
            $excludingGst = $order->getGstExclusive();
            $total = 0;
