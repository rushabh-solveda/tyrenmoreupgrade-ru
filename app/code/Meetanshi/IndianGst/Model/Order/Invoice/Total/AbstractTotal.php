...
class AbstractTotal extends InvoiceAbstractTotal
{
    ...
    public function __construct(HelperData $helper, ProductFactory $productFactory, OrderFactory $orderFactory, CategoryRepositoryInterface $categoryRepository, StoreManagerInterface $storeManager)
    {
        $this->helper = $helper;
