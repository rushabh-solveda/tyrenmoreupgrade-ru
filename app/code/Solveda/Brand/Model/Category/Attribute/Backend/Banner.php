...
namespace Solveda\Brand\Model\Category\Attribute\Backend;
    ...
    private function getImageUploader()
    {
        if ($this->imageUploader === null) {
            $this->imageUploader = \Magento\Framework\App\ObjectManager::getInstance()
                ->get(\Magento\Catalog\CategoryBannerImageUpload::class);
        }
...
//         if ($this->imageUploader === null) {
//             $this->imageUploader = \Magento\Framework\App\ObjectManager::getInstance()
//                 ->get(\Magento\Catalog\CategoryCertificateImageUpload::class);
//         }
