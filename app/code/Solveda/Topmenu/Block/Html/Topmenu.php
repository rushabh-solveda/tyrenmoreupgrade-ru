...
namespace Solveda\Topmenu\Block\Html;
...
class Topmenu extends \Magento\Theme\Block\Html\Topmenu
{
    ...
    protected function _getHtml(
        ...
        foreach ($children as $child) {
            ...
            $link =  '<a href="' . $child->getUrl() . '" ' . $outermostClassCode . '><span class="text">' . $this->escapeHtml(
                $child->getName()
            ...
            if($child->getId() == 'category-node-46') {
                $html .= '<h1 class="top-menu-navigation">'.$link.'</h1>';
            } else {
                $html .= '<h2 class="top-menu-navigation">'.$link.'</h2>';
            }
            $html .=  '</li>';
            $counter++;
        }
