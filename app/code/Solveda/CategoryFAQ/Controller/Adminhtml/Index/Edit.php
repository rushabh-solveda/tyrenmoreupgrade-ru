...
class Edit extends \Magento\Backend\App\Action
{
    ...
    protected function _initAction()
    {
        ...
        $resultPage->setActiveMenu('Solveda_CategoryFAQ::main')
            ->addBreadcrumb(__('Solveda'), __('Solveda'))
    ...
    public function execute()
    {
        ...
        $model = $this->_objectManager->create('Solveda\CategoryFAQ\Model\CategoryFAQ');
        ...
        $this->_coreRegistry->register('categoryfaq', $model);
