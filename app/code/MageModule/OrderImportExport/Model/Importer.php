...
use MageModule\OrderImportExport\Exception\BillingAddressException;
use MageModule\OrderImportExport\Exception\ImportException;
use MageModule\OrderImportExport\Exception\ShippingAddressException;
...
class Importer implements \MageModule\OrderImportExport\Api\ImporterInterface
{
    ...
    /**
     * @var \MageModule\OrderImportExport\Model\Registry
     */
    private $registry;
     ...
     * @param \MageModule\OrderImportExport\Model\Registry                     $registry
    ...
    public function __construct(
        ...
        \MageModule\OrderImportExport\Model\Registry $registry,
    ...
    {
        $this->registry->setIsOrderImportExport(true);
        ...
        try {
            ...
            throw new BillingAddressException(
                ImportException::IMPORT_STATUS_NO,
                __($e->getMessage()),
                $e
            );
        ...
        try {
            ...
            throw new ShippingAddressException(
                ImportException::IMPORT_STATUS_NO,
                __($e->getMessage()),
                $e
            );
        ...
        $this->registry->setIsOrderImportExport(false);
