...
return [
    'modules' => [
        ...
        'Advancetyre_Tyreadvanceserch' => 1,
        'Amasty_Base' => 1,
        'Amasty_Conditions' => 1,
        ...
        'Bss_MultiStoreViewPricingTierPrice' => 1,
        'Cadence_Fbpixel' => 0,
        'Carbikebrand_Bikesearch' => 1,
        'Carbikebrand_Carsearch' => 1,
        'Clarksfield_Customersspeak' => 1,
        'Custom_Js' => 1,
        'Dev_Testing' => 1,
        ...
        'MageWorx_ExtendedOrdersGrid' => 1,
        'MageWorx_ExtendedOrdersSku' => 1,
        'Magecomp_Customshipping' => 1,
        'Magecomp_Orderconfirmmail' => 1,
        'Mageplaza_Core' => 1,
        'Mageplaza_BackendReindex' => 0,
        'Mageplaza_BannerSlider' => 1,
        'Mageplaza_Blog' => 0,
        'Mageplaza_AbandonedCart' => 0,
        'Mageplaza_DeleteOrders' => 0,
        'Mageplaza_DeliveryTime' => 0,
        'Mageplaza_GeoIP' => 0,
        'Mageplaza_GoogleRecaptcha' => 0,
        'Mageplaza_Osc' => 0,
        'Mageplaza_ProductFeed' => 0,
        'Meetanshi_IndianGst' => 0,
        'Navyuginfo_CascadeSearch' => 1,
        'PayPal_Braintree' => 1,
        ...
        'Prince_Buynow' => 1,
        'Razorpay_Magento' => 1,
        'Shorting_Pricecatalog' => 0,
        'Solveda_Brand' => 1,
        'Solveda_CategoryFAQ' => 1,
        'Solveda_CategoryProductPrice' => 1,
        'Solveda_Catlog' => 1,
        'Solveda_Checkout' => 1,
        'Solveda_CrossSell' => 1,
        'Webkul_PriceList' => 1,
        'Solveda_PdpChangeLayout' => 1,
        'Solveda_ProductFilter' => 1,
        'Solveda_ShippingCities' => 1,
        'Solveda_SortProduct' => 1,
        'Solveda_Topmenu' => 1,
        'Tatvic_ActionableGoogleAnalytics' => 1,
        'Tatvic_EnhancedEcommerce' => 0,
        'Temando_ShippingRemover' => 1,
        'Tyres_Faq' => 1,
        'Tyres_Menu' => 1,
        'Tyresclarksfield_Testimonials' => 1,
        'Vendor_Module' => 1,
        'Vertex_Tax' => 1,
